...
The figures included in the paper arise from calling the scripts ```createFigs_v06.R```
and ```markupDependenceFigs_v02.R``` from their folder, which load the relevant workspace from 
...
Run ```FRED-MD_figures.R``` to produce the figures in the empirical illustration
